...
describe("VideoAsciiPlayer", () => {
  ...
  it("displays first frame initially", () => {
    ...
    render(
      <VideoAsciiPlayer videoSrc="test-video.mp4" frames={frames} fps={10} />,
    );
  ...
  it("cycles through frames at specified fps", () => {
    ...
    render(
      <VideoAsciiPlayer videoSrc="test-video.mp4" frames={frames} fps={fps} />,
    );
  ...
  it("returns null when frames array is empty", () => {
    const { container } = render(
      <VideoAsciiPlayer videoSrc="test-video.mp4" frames={[]} fps={10} />,
    );
  ...
  it("updates frame at correct interval for different fps values", () => {
    ...
    const { unmount } = render(
      <VideoAsciiPlayer videoSrc="test.mp4" frames={frames} fps={1} />,
    );
    ...
    render(<VideoAsciiPlayer videoSrc="test.mp4" frames={frames} fps={20} />);
